...
var yourCharacterList = [
   ["assets/images/obi_wan_green.jpg", "Obi-Wan Kenobi", 150],
   ["assets/images/luke_skywalker_green.jpg", "Luke Skywalker", 144],
   ["assets/images/darth_sidious_green.jpg", "Darth Sidious", 113],
   ["assets/images/darth_maul_green.jpg", "Darth Maul", 119]
];
var enemiesList = [
...
function removeEnemy (src) {

  console.log("src=", src);
  src = src.replace("green","red");
  src = src.replace("black","red");
  console.log("src=", src);
  console.log("removeEnemy: "+enemiesList);
  for (i=0; i < enemiesList.length; i++) {
     if (enemiesList[i][0] == src) {
...
$('.image-row2').click(function(){
   ...
   console.log("enemiesList.length="+enemiesList.length)
